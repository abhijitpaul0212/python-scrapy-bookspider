...
class BookspiderSpider(scrapy.Spider):
    ...
    # custom settings overwrites whatever specified in FEEDS in settings.py
    custom_settings = {
        'FEEDS': {
    ...
    def parse(self, response):
        ...
        next_page = response.css('li.next a ::attr(href)').get()  # nextPage link at bottom of each page
